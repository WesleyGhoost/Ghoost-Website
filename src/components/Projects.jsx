...
import { ProjectSoon, ProjectsContainer, ProjectsDescrip, ProjectsDetails, ProjectsImgs, ProjectsSubTitle, ProjectsTitle } from '../Styles/ProjectsStyle';
    ...
    return (
        <>
            ...
            <ProjectsContainer>
                ...
                <a className="projects" id='fifthProject' href="https://github-finder-weld-theta.vercel.app/"><ProjectsImgs height="200" width="380" src={GithubFinder} alt="Github Finder" /></a>
                ...
                <a className='projects' id='seventhProject' href="https://codepen.io/_Ghoost_/pen/PoOMXpr"><ProjectsImgs height="200" width="380" src={TopMovies} alt="Top 5 Movies" /></a>
                <ProjectsImgs className="projects" id='eighthProject' height="200" width="380" src={BattleCards} alt="Battle Cards" />

                <ProjectsDetails className='project-details' id='seventhDetail'>
                ...
                <ProjectSoon className='project-details' id='eighthDetail'>Em breve...</ProjectSoon>
            </ProjectsContainer>
        </>
    )
}
