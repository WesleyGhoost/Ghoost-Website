            ...
            <AboutContainer id='about'>
                ...
                {language === 'pt' ?
                    <AboutMe className='about'>
                        <h1>Sobre mim</h1>
                        <h3>
                            Olá, meu nome é <strong>Wesley Felix</strong>, sou um <strong>desenvolvedor front-end jr</strong>, tenho 20 anos, e nasci e moro atualmente em São Paulo. Terminei o ensino médio e depois de mais de um dois anos estudando programação, eu pretendo me ingressar na área o mais breve possível.
                        </h3>
                        <h3>
