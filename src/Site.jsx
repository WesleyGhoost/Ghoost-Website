...
const Site = () => {
  return (
    <ContainerAll id='intro'>
      ...
      <LanguagesTitle id='languages'>Linguagens utilizadas</LanguagesTitle>
      <Languages>
        <img height="65" width="65" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" alt="HTML"/>
        <img height="65" width="65" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg" alt="CSS"/>        
        <img height="65" width="65" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" alt="Javascript"/>
        <img height="65" width="65" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg" alt="React"/>
        <img height="65" width="65" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" alt="Git" />
        <LanguagesReposit>
      ...
      <ProjectsTitle id='projects'>Principais Projetos</ProjectsTitle>
      <ProjectsSubTitle>Esses são os que considero como meus principais projetos, pois sinto que foi principalmente com estes que mais aprendi. Outros projetos podem ser acessados no meu <a href="https://github.com/WesleyGhoost">Github</a></ProjectsSubTitle>
      <ProjectsSubTitle>Os projetos com a estrela dourada <img src={GoldStar} alt="estrela dourada" /> representam os projetos que foram feitos 100% por mim, já os com a estrela azul <img src={BlueStar} alt="estrela azul" />representam projetos nos quais eu somente acrescentei novos conteúdos.</ProjectsSubTitle>
      <Projects>
        <a id='firstElement' href="https://playflix-six.vercel.app/"><ProjectsImgs height="200" width="380" src={Playflix} alt="Playflix" /></a>
        <a id='thirdElement' href="https://wesleyghoost.github.io/Trilhas-Sonoras-Classicas-de-Games/"><ProjectsImgs height="200" width="380" src={ClassicTracks} alt="Landing Page" /></a>
        <ProjectsDetails id='secondElement'>
        ...
        <ProjectsDetails id='fourthElement'>
          <summary>Trilhas Sonoras</summary>
          <ProjectsDescrip>
        ...
        <a id='fifthElement' href="https://wesleyghoost.github.io/Relaxing-Form/"><ProjectsImgs height="200" width="380" src={RelaxingForm} alt="Relaxing Form" /></a>
        <a id='seventhElement'href="https://wesleyghoost.github.io/Landing-page/"><ProjectsImgs height="200" width="380" src={LandingPage} alt="Landing Page" /></a>
        <ProjectsDetails id='sixthElement'>
        ...
        <ProjectsDetails id='eighthElement'>
        ...
        <a id='ninthElement' href="https://codepen.io/_Ghoost_/pen/PoOMXpr"><ProjectsImgs height="200" width="380" src={TopMovies} alt="Top 5 Movies" /></a>  
        <a id='eleventhElement' href="https://wesleyghoost.github.io/Jumper-Mario/"><ProjectsImgs height="200" width="380" src={JumperMario} alt="Jumper Mario" /></a>
        <ProjectsDetails id='tenthElement'>
        ...
        <ProjectsDetails id='twelfthElement'>
